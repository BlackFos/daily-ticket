export type AssetEntry = {
  ...
  alt: string;
  role: string;
  source: "ticket-bora-reference" | "daily-ticket-original";
  replaceable: boolean;
};
...
export const assets = {
  brand: {
    mark: {
      id: "brand-mark",
      src: "/assets/brand/daily-ticket-mark.svg",
      alt: "데일리티켓",
      role: "header, hero, footer brand mark",
      source: "daily-ticket-original",
      replaceable: true,
    },
    search: {
      id: "naver-search",
      src: "/assets/brand/daily-ticket-search.svg",
      alt: "네이버에서 데일리티켓을 검색하세요",
    ...
    kakaoQr: {
      id: "kakao-qr",
      src: "/assets/brand/daily-ticket-kakao-qr.png",
      alt: "데일리티켓 카카오톡 상담 QR",
  ...
  common: {
    hero: {
      id: "hero-phone",
      src: "/assets/common/daily-hero-v2.png",
      alt: "",
    ...
    process: {
      id: "process-steps",
      src: "/assets/common/process-steps-daily.png",
  ...
  why: [
    ["why-speed", "/assets/icons/why-speed-daily.png", "빠른 안내"],
    ["why-service", "/assets/icons/why-service-daily.png", "친절한 상담"],
    ["why-registered", "/assets/icons/why-registered-daily.png", "정식 등록"],
    ["why-safe", "/assets/icons/why-safe-daily.png", "안전한 절차"],
  ].map(([id, src, alt]) => ({
    id,
    src,
    alt,
