...
const assetJobs = [
  {
    ...
    output: "public/assets/common/process-steps-daily.png",
  },
  {
    input: "public/assets/icons/why-speed.png",
    output: "public/assets/icons/why-speed-daily.png",
  },
  {
    input: "public/assets/icons/why-service.png",
    output: "public/assets/icons/why-service-daily.png",
  },
  {
    input: "public/assets/icons/why-registered.png",
    output: "public/assets/icons/why-registered-daily.png",
  },
  {
    input: "public/assets/icons/why-safe.png",
    output: "public/assets/icons/why-safe-daily.png",
  },
];
...
async function recolor(job) {
  ...
  for (let index = 0; index < data.length; index += info.channels) {
    ...
    if (hue >= 245 && hue <= 315 && saturation >= 0.18) {
      const targetHue = lightness < 0.42 ? 174 : 169;
      const targetSaturation = Math.min(0.72, Math.max(0.36, saturation * 0.82));
