...
- `public/assets/brand/daily-ticket-mark.svg`: 캘린더형 티켓 심볼
- `public/assets/brand/daily-ticket-search.svg`: 네이버 검색 배너
- `public/assets/brand/daily-ticket-kakao-qr.png`: 실제 카카오 링크 QR
- `public/assets/common/daily-hero-v2.png`: 민트 재킷 캐릭터 히어로, 398×422
- `public/assets/common/process-steps-daily.png`: 데일리 민트 톤 HOW 이미지
- `public/assets/icons/why-*-daily.png`: 데일리 민트 톤 WHY 아이콘 4종
...
현재 공식 링크는 `https://open.kakao.com/o/sd88tpJi`다.
